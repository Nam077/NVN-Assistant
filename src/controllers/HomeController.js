...
let getCrawler = async(req, res) => {
    try {
        ...
        let team1 = $(data).find("span.GV3Hqc").first().text();
        console.log(team1);
        let loc = $(data).find("table.qyEGdc").first();
        let loc2 = $(loc).find("div.m7B03 > div > div > div > span").first().text();
        let loc3 = $(loc).find("div.m7B03 > div > div > div > span").last().text();
        console.log(loc2)
        console.log(loc3)
            // let loc = $(data).find("span.GV3Hqc").first().text();
            // console.log(loc);
            // let team1 = $(data).find("div.amyZLb").first().text();
            // console.log(team1);
            // let all = $(data).find("div.m7B03 > div >div>div.ruktOc").first().text();
            // console.log(all);
            // let team2 = $(data).find("div.amyZLb").last().text();
            // console.log(team2);
            // let all2 = $(data).find("div.m7B03 > div >div>div.ruktOc").last().text();
            // console.log(all2);
